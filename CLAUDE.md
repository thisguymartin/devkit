...
- `@coder` -- autonomous test-fix loops when the spec and tests are clear (GPT-4.1 via OpenAI API)
...
- `@qa` -- test generation, execution, and BDD flows (GPT-4.1-mini via OpenAI API)
- `@docs_generator` -- documentation (Gemini 3 Flash)
- `@linear` -- Linear project management (GPT-4.1-mini via OpenAI API)
